...
string VisitComp::visit(BinaryArrayNode* ban, int flag) {
    ...
    return "BE CAREFULL : VISIT NOT IMPLEMENTED FOR THIS NODE binary!\n";
}
...
string VisitComp::visit(TernaryArrayNode* tan, int flag) {
    ...
    if(flag == 0) {
        ...
        temp += "newarrray(" + tan->getChildren()[1]->getChildren()[0]->getLabel() + ",";
    ...
    return temp;
    //return "BE CAREFULL : VISIT NOT IMPLEMENTED FOR THIS NODE (ternary node)!\n";
}
